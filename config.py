...
OWNER_IMG_PATHS  = ["/app/owner1.jpeg", "/app/owner2.jpeg", "/app/owner3.jpeg"]
...
#THINGSPEAK_WRITE_KEY = "2972245"
#THINGSPEAK_CHANNEL_ID = "PNXX1ULLNUGJKC9T"
#THINGSPEAK_READ_KEY = "WQNHQR7DG6UVHKAD"

#THINGSPEAK_CHANNEL_ID = os.getenv("TS_CHANNEL_ID", "PNXX1ULLNUGJKC9T")
#THINGSPEAK_WRITE_KEY  = os.getenv("TS_WRITE_KEY",   "2972245")
#THINGSPEAK_READ_KEY   = os.getenv("TS_READ_KEY",   "WQNHQR7DG6UVHKAD")
#THINGSPEAK_POLL_SEC   = 15      # subscribe_to_field2 polling interval

THINGSPEAK_CHANNEL_ID = os.getenv("TS_CHANNEL_ID", "2972245")
THINGSPEAK_WRITE_KEY  = os.getenv("TS_WRITE_KEY",  "WQNHQR7DG6UVHKAD")
THINGSPEAK_READ_KEY   = os.getenv("TS_READ_KEY",    "PNXX1ULLNUGJKC9T")
THINGSPEAK_POLL_SEC   = 15
